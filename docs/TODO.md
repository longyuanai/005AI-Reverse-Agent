...
> **项目状态**: YARA-001 complete ✅ (275/275 tests passing)
...
| ID | 任务 | 状态 | 启动日 | 完成日 | 备注 |
|----|------|------|-------|-------|------|
| YARA-001 | 基于静态 FeatureIndex 生成 YARA 规则 | done | 2026-08-01 | 2026-08-01 | 标准 pe_imphash、筛选字符串、SHA-256 fallback；无新增生产依赖 |
